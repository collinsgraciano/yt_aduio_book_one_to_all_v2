...
#
# 用法：
#   bash scripts/project_export.sh                  # 不含输出文件
#   bash scripts/project_export.sh --with-output     # 含输出文件
#   bash scripts/project_export.sh /tmp              # 导出到指定目录
...
while [ $# -gt 0 ]; do
    case "$1" in
        ...
        -h|--help)
            echo "用法: bash scripts/project_export.sh [目录] [--with-output]"
            echo ""
            echo "参数:"
...
echo "    bash scripts/project_import.sh $(basename "$BUNDLE_FILE")"
echo ""
echo "═══════════════════════════════════════════════════"
